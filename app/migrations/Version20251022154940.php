 ...
 */
final class Version20251022154940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE territoire (id INT AUTO_INCREMENT NOT NULL, province VARCHAR(255) NOT NULL, pcode_province VARCHAR(20) DEFAULT NULL, territoire VARCHAR(255) NOT NULL, pcode_territoire VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE zone_sante (id INT AUTO_INCREMENT NOT NULL, province VARCHAR(255) NOT NULL, pcode_province VARCHAR(20) DEFAULT NULL, territoire VARCHAR(255) NOT NULL, pcode_territoire VARCHAR(20) DEFAULT NULL, zone_de_sante VARCHAR(255) NOT NULL, pcode_zs VARCHAR(20) DEFAULT NULL, pop2019 VARCHAR(50) DEFAULT NULL, pop2020 VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
